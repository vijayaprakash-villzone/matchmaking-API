...
/*
 * Source-reference special case:
 * Mercury + Venus = Medium Match
 * Venus + Mercury = Medium Match
 */
if (
    ($gl === 4 && $bl === 6) ||
    ($gl === 6 && $bl === 4)
...
/*
 * Preserve source's special 7th-rasi handling.
 * Only apply when the rasi distance is exactly 7.
 */
